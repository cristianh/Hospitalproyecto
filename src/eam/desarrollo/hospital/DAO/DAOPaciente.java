...
public class DAOPaciente implements IntPaciente {
	...
	public void crear(Paciente paciente) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Usuario registrado", "Info",
	...
	public Paciente buscar(String identificacion) throws Exception {
		// TODO Auto-generated method stub
				...
				if (res.next()) {
					...
					/*Tipodocumento tipodocumento= new Tipodocumento(res.getObject(9).toString(), );
					Municipio municipio= new Municipio(Integer.toString(JCBMunicipioPaciente.getSelectedIndex()), JCBMunicipioPaciente.getSelectedItem().toString());*/
					//Genero genero = new Genero(Integer.toString(JCBGeneroPaciente.getSelectedIndex()), JCBGeneroPaciente.getSelectedItem().toString());
					...
					paciente = new Paciente(idPaciente, nombrePaciente, apellidoPaciente, direccionPaciente, fechaNacimientoPaciente, telefonoPaciente, pesoPaciente, numeroDocumentoPaciente,documento, municipio, genero);
				}
				con.close();
				return paciente;
	}
